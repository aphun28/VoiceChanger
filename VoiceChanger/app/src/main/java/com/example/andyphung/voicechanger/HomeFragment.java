...
public class HomeFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater,
        ...
        if(com.example.andyphung.voicechanger.InternetAvail.getInstance(getActivity().getApplicationContext()).isOnline())
	    {
		new DownloadTwitterTask().execute("quotepage");
	    }
	    else
	    {
		  ...
		  public Object instantiateItem(ViewGroup container, int position) {
	          ...
	          tweet.setMovementMethod(new ScrollingMovementMethod());
	            ...
	            name.setOnClickListener(new OnClickListener() {
					...
					@Override
					public void onClick(View v) {
						String url = "https://twitter.com/quotepage?lang=en";
