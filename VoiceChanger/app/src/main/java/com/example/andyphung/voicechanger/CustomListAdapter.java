...
public class CustomListAdapter extends BaseAdapter{
    ...
    private ArrayList<com.example.andyphung.voicechanger.NavDrawerItem> navDrawerItems;
    private SharedPreferences appPrefs;
     
    public CustomListAdapter(Context context, ArrayList<com.example.andyphung.voicechanger.NavDrawerItem> navDrawerItems){
