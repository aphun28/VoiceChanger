...
public class SocialFragment extends Fragment {
	...
	private RecyclerView.Adapter<com.example.andyphung.voicechanger.SocialTweetsAdapter.CustomViewHolder> mAdapter;
	...
	public View onCreateView(LayoutInflater inflater,
	    ...
	    {
		new DownloadSocialTwitterTask().execute("#quote");
	    }
	    else
	    {
	...
	// Uses an AsyncTask to download a Twitter user's timeline
		private class DownloadSocialTwitterTask extends AsyncTask<String, Void, String> {
			...
			protected void onPostExecute(String result) {
				...
				mAdapter = new com.example.andyphung.voicechanger.SocialTweetsAdapter(getActivity().getApplicationContext(), statuses); // RecyclerView.Adapter
